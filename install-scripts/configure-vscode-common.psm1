...
$defaultEsp32ComPortPattern = "<default-com-port-for-esp32>"
...
function Update-Paths {
    ...
    if($env:NF_ESP32_COMPORT)
    {
        $content = $content -replace $defaultEsp32ComPortPattern, $env:NF_ESP32_COMPORT
    }
    else {
        $content = $content -replace $defaultEsp32ComPortPattern, 'COM1'
    }
