...
#define FLASH_PEKEY2                                                                                                   \
    ((uint32_t)0x02030405U) /*!< Flash program erase key: used with FLASH_PEKEY2                                       \
                                to unlock the write access to the FLASH_PECR register and                              \
                                data EEPROM */

#define FLASH_PRGKEY1 ((uint32_t)0x8C9DAEBFU) /*!< Flash program memory key1 */
#define FLASH_PRGKEY2                                                                                                  \
    ((uint32_t)0x13141516U)               /*!< Flash program memory key2: used with FLASH_PRGKEY2                      \
...
#define FLASH_FLAG_ALL_ERRORS                                                                                          \
    (FLASH_FLAG_WRPERR | FLASH_FLAG_PGAERR | FLASH_FLAG_SIZERR | FLASH_FLAG_OPTVERR | FLASH_FLAG_RDERR |               \
