...
__nfweak int nanoBooter_GetTargetInfo(TargetInfo *targetInfo)
{
    ...
    targetInfo->BooterVersion.usMajor = VERSION_MAJOR;
    targetInfo->BooterVersion.usMinor = VERSION_MINOR;
    targetInfo->BooterVersion.usBuild = VERSION_BUILD;
    targetInfo->BooterVersion.usRevision = VERSION_REVISION;
