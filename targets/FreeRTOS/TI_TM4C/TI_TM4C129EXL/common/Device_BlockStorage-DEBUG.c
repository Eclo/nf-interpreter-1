...
{
    { BlockRange_BLOCKTYPE_BOOTSTRAP ,    0 , 8    },            // 0x08000000 nanoBooter
    { BlockRange_BLOCKTYPE_CODE      ,    9 , 104  },            // 0x08004800 nanoCLR
    { BlockRange_BLOCKTYPE_DEPLOYMENT,   105, 127  }             // 0x08034800 deployment
};
